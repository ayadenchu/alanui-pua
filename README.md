...
### 目的
SNSを利用する上で誹謗中傷が問題視されていることを背景に悪評価というものそのものを見つめなおすという意図を込め作成したアプリケーションです。
...
### Bud機能
 ...
 Budを押すを選択するとBud評価を押す事ができる。
 
### Bud評価が5つ付くと投稿にcloseと表示される

 closeが表示されるとお気に入りとBudは付ける事ができなくなる。
...
悪評価（Bud評価）というものそのもの概念を重くする事が狙い。
